    ...
    <div class="col-12 col-xl-8">
        <div class="card mb-4">
            <div class="card-body">
                ...
                ?>
                <form action="comment_upd.php" id="commentUpdForm" method="post" enctype="multipart/form-data">
                    ...
                    ?>
                                <div class="form-group">
                                    <label for=""><?php echo user($c['user_id'])['name']; ?></label>
                                    <input type="hidden" name="commentId" value="<?php echo $c['id']; ?>">
                                    <textarea class="form-control" name="comment" rows="2 " required><?php echo $c['comment']; ?></textarea>
                                </div>
                            <?php
                            } else {
                            ?>
                                <div class="form-group">
                                    ...
                                    <textarea disabled class="form-control" name="comment" rows="2 " required><?php echo $c['comment']; ?></textarea>
                                </div>
                        <?php
                            }
                        }
...
$("#commentUpdForm").on("submit", function(e) {
        e.preventDefault();
